      ...
      <div className="relative w-full max-w-screen-2xl min-h-[80vh] md:min-h-[75vh] rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 p-4 sm:p-8 overflow-hidden flex flex-col shadow-2xl">
        <div className="relative flex flex-col sm:flex-row items-start justify-between mb-4 shrink-0 gap-4 sm:gap-0">
          <div className="flex items-start gap-3">
            ...
            <div className="pt-1">
              <p className="text-[10px] sm:text-[11px] tracking-wide text-red-400/80 mb-1">{project.category}</p>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
            <a
              ...
              className="group relative flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/5 border border-white/10 text-white/70 hover:text-white hover:bg-white/10 transition-all duration-300"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="relative flex items-center gap-3 px-5 py-2 sm:px-8 sm:py-3 rounded-full bg-gradient-to-b from-gray-100 to-gray-300 text-black font-black text-xs sm:text-sm uppercase tracking-widest transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(255,255,255,0.2)] active:scale-95 border border-white/20"
            >
